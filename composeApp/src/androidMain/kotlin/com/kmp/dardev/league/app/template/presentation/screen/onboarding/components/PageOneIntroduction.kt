    ...
    Scaffold {
        Box(
            ...
            Column(
                ...
                // Titre
                Text(
                    text = AndroidStringResource(id = SharedRes.strings.page_one_title),
                ...
                // Description
                Text(
                    text = AndroidStringResource(id = SharedRes.strings.page_one_topic),
                    textAlign = TextAlign.Center,
...
@Preview
@Composable
fun PageOneIntroductionPreview() {
    val context = LocalContext.current
    AppTheme {
        PageOneIntroduction({}, context)
    }
}

@Preview(uiMode = UI_MODE_NIGHT_YES, showSystemUi = true)
@Composable
fun PageOneIntroductionDarkModePreview() {
    val context = LocalContext.current
    AppTheme {
        PageOneIntroduction({}, context)
    }
