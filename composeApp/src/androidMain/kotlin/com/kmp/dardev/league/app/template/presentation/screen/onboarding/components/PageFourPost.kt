    ...
    Scaffold {
        Box(
            ...
            Column(
                ...
                // Titre
                Text(
                    text = AndroidStringResource(id = SharedRes.strings.page_four_title),
                ...
                // Description
                Text(
                    text = AndroidStringResource(id = SharedRes.strings.page_four_topic),
                    textAlign = TextAlign.Center,
...
@Preview(locale = "fr")
@Composable
fun PageFourPostPreview() {
    val context = LocalContext.current
    AppTheme {
        PageFourPost({}, context)
    }
}

@RequiresApi(Build.VERSION_CODES.N)
@Preview(uiMode = UI_MODE_NIGHT_YES, locale = "en")
@Composable
fun PageFourPostDarkModePreview() {
    val context = LocalContext.current
    AppTheme {
        PageFourPost({}, context)
    }
