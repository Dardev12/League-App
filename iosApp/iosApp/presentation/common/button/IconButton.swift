    ...
    var body: some View {
        Button(action: {
            ...
            ZStack{
                ...
                RoundedRectangle(cornerRadius: 10, style: .continuous).fill(Color.iconbuttonBackground).frame(width: 36.5,height: 35.96).shadow(radius: 2)
                Image(systemName: content).resizable().frame(width: 16.5,height: 15.96).foregroundColor(Color.errorColor)
            }
        }
    }
}
    ...
    var body: some View {
        Button(action: {
            ...
            ZStack{
                ...
                RoundedRectangle(cornerRadius: 10, style: .continuous).fill(Color.iconbuttonBackground).frame(width: 40,height: 40).shadow(radius: 2)
                Image(systemName: content).resizable().frame(width: 25,height: 25).foregroundColor(Color.errorColor)
            }
        }
    }
}
