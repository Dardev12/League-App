                    ...
                    Group {
                        ...
                        if termsAccepted {
                            if isLoading {
                                ...
                                AppButton(text: IosStringResources(id: SharedRes.strings().enroll_text_button, args: []), condition: selectionApplyHome)
                            }
                        } else {
