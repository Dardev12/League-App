            ...
            Task {
                do {
                    ...
                    if let idToken = user.idToken?.tokenString {
                        let signInData = SignInGoogleData(id: user.userID ?? "", email: user.profile?.email ?? "", token: "")
                ...
                VStack {
                    ...
                    //Group {
                        ...
                        if isLoading {
                            ...
                            AppButton(text: IosStringResources(id: SharedRes.strings().connexion_text_button, args: []), condition: selectionApplyHome)
                        }
                        Spacer()
                        HStack(spacing: 5) {
